...
//publishTestResult type:'unit', fileLocation: '/var/jenkins_home/workspace/Jenkins-Github/simpleTest.json'
                    publishTestResult fileLocation: '/var/jenkins_home/workspace/Jenkins-Github/target/surefire-reports/TEST-com.mycompany.app.AppTest.xml', type: "unit", serviceName: "ServiceNameTest", hostName: "local-dash.gravitant.net", testType: "unit"
                }
}
    }
}
